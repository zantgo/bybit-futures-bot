...
# core/logging/closed_position_logger.py
"""
...
# Importar config para obtener la ruta del archivo log
# Usar try-except para manejar posible ImportError
try:
    import config
    from core import utils # Para serializar datetime, numpy
    ...
    config = type('obj', (object,), {'POSITION_MANAGEMENT_ENABLED': False, 'POSITION_LOG_CLOSED_POSITIONS': False})() # Dummy config
    utils = None
...
def log_closed_position(position_data: dict):
    ...
    try:
        ...
        # print(f"  Datos que fallaron al escribir: {position_data}")
        traceback.print_exc()