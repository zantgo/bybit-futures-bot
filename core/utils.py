# core/utils.py
"""
Módulo con funciones de utilidad generales reutilizables (v6.2.5 - + safe_division).
"""
import datetime
import pandas as pd
import numpy as np
...
def format_datetime(dt_object: datetime.datetime | pd.Timestamp | None, fmt: str = '%Y-%m-%d %H:%M:%S') -> str:
